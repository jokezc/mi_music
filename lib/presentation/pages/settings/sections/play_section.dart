  ...
  Future<void> _loadSettings() async {
    try {
      ...
      setState(() {
        ...
        _fuzzyMatchCutoffController.text =
            setting.fuzzyMatchCutoff?.toString() ?? '0.6';
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      ...
      final updatedSetting = _currentSetting!.copyWith(
        ...
        loudnorm: _loudnormController.text.trim().isEmpty
            ? null
            : _loudnormController.text.trim(),
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                inputFormatters: [
                  FilteringTextInputFormatter.allow(RegExp(r'^0\.[1-9]\d*$|^0\.9$|^0\.\d*$')),
                ],
              ),
              const SizedBox(height: 16),
              SwitchListTile(
